// Table types
//1. Permanent (CREATE TABLE 1.Time travel retention period 1-9 0days 2.fail safe)
//2. Transient (CREATE TRANSIENT TABLE  1.Time travel retention period 1 day 2.NOT fail safe )
//3. Temporary (CREATE TEMPORARY TABLE  1.Time travel retention period 1 day 2.NOT fail safe 3.Only exist in the session)
...
// Undropping is not possible because retentiontime was set to 0 
...
// this creates an error due to extended retention time set to 2 
